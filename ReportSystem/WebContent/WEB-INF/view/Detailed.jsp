...
<% SectionBean sb = (SectionBean)request.getAttribute("section");%>
...
<h1 align="center">就職試験結果報告書</h1>
	...
	<label class="label">ヘッダー番号：<input readonly="readonly" type="text" name="number" value=<%=sb.getHeader()%>></label>
	...
	<table class="type02" align="center">
			...
			<tr>
				<th scope="row">電話</th>
				<td><label><%=sb.getPhone()%></label></td>
			</tr>
			<tr>
				<th scope="row">所在地</th>
				<td><%=sb.getLocation()%></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">業種</th>
				<td><%=sb.getIndustry()%></td>
			</tr>
			<tr>
				<th scope="row">職種</th>
				<td><%=sb.getOccupations()%></td>
			</tr>
			<tr>
				<th scope="row">１次試験報告</th>
				<td><%=sb.getComment1()%></td>
			</tr>
			<tr>
				<th scope="row">２次試験報告</th>
				<td><%=sb.getComment2()%></td>
			</tr>
			<tr>
				<th scope="row">３次試験報告</th>
				<td><%=sb.getComment3()%></td>
			</tr>
	</table>
